 ...
 * @see WP_Widget
 */
class CommonWidget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'classname' => 'widget_text_charm',
            'description' => __( 'Arbitrary text Sidebar.' ),
    ...
    public function widget( $args, $instance ) {
        ...
        echo '<div class="item_catego_new_r">';
        echo $args['before_widget'];
        if ( ! empty( $title ) ) {
            echo ' <div class="title_left_catego">
                        <span class="font_gothic_bold">' . $title . '</span>
                 </div>';
        }
    ...
    public function enqueue_preview_scripts() {
        ...
        require_once __DIR__ . '/../../../../../wp-includes/media.php';
...
add_action( 'widgets_init', 'create_text_charm_widget' );
function create_text_charm_widget() {
    register_widget('CommonWidget');
}