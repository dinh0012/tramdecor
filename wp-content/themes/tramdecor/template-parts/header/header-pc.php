<header class="Header Header--top">
    <div class="Header-inner Header-inner--top" data-nc-group="top">
        <div data-nc-container="top-left">
            ...
            <a href="/" class="Header-branding" data-nc-element="branding" data-content-field="site-title">
                ...
                <img src="//static1.squarespace.com/static/5b8bf301e2ccd13e972a0ab4/t/5ba8b62b15fcc0772b6ffe75/1538382333870/?format=1500w" alt="Tramdecor" class="Header-branding-logo">
    ...
    <span class="Header-nav-item Header-nav-item--folder">
      ...
      <a href="/thiet-ke-noi-that/" class="Header-nav-folder-title" data-controller="HeaderNavFolderTouch" data-controllers-bound="HeaderNavFolderTouch">Thiết kế</a>
      ...
      <span class="Header-nav-folder">
            ...
            <a href="/vn/thiet-ke-quan-cafe/" class="Header-nav-folder-item" data-test="template-nav">THIẾT KẾ QUÁN CAFE</a>



            <a href="/vn/thiet-ke-nha-hang/" class="Header-nav-folder-item" data-test="template-nav">THIẾT KẾ NHÀ HÀNG</a>



            <a href="/vn/thiet-ke-cua-hang/" class="Header-nav-folder-item" data-test="template-nav">THIẾT KẾ CỬA HÀNG</a>
      ...
      <a href="/design/" class="Header-nav-folder-title" data-controller="HeaderNavFolderTouch" data-controllers-bound="HeaderNavFolderTouch">Design</a>
      ...
      <span class="Header-nav-folder">
            ...
            <a href="/en/restaurant-designs/" class="Header-nav-folder-item" data-test="template-nav">RESTAURANT DESIGNS</a>
      ...
      <a href="/suunnittelu/" class="Header-nav-folder-title" data-controller="HeaderNavFolderTouch" data-controllers-bound="HeaderNavFolderTouch">Suunnittelu</a>
      ...
      <span class="Header-nav-folder">
            ...
            <a href="/fi/toimiston-sisustus/" class="Header-nav-folder-item" data-test="template-nav">TOIMISTON SISUSTUS</a>
            ...
            <a href="/fi/kahvilan-sisustus/" class="Header-nav-folder-item" data-test="template-nav">KAHVILAN SISUSTUS</a>
